...
export const COMMIT_MESSAGE_LABEL = {
  [VALID_COMMAND_TYPES.COMMIT_MESSAGE_LABELS[0]]: 'feat',
  [VALID_COMMAND_TYPES.COMMIT_MESSAGE_LABELS[1]]: 'fix',
  [VALID_COMMAND_TYPES.COMMIT_MESSAGE_LABELS[2]]: 'enhance',
  [VALID_COMMAND_TYPES.COMMIT_MESSAGE_LABELS[3]]: 'chore',
  [VALID_COMMAND_TYPES.COMMIT_MESSAGE_LABELS[4]]: 'docs',
};
